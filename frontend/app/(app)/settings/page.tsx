...
import {
  ACTIVITY_LEVEL_OPTIONS, DIET_PREFERENCE_OPTIONS,
  FITNESS_GOAL_OPTIONS, GENDER_OPTIONS, WORKOUT_EXPERIENCE_OPTIONS,
...
export default function SettingsPage() {
  ...
  function SelectField({ name, label, options }: { name: keyof FormValues; label: string; options: readonly { value: string; label: string }[] }) {
    return (
      <FormField
              ...
              <Form {...form}>
                <form onSubmit={form.handleSubmit(d => mutation.mutate(d))} className="space-y-4">
                  <div className="grid gap-4 sm:grid-cols-2">
                    ...
                    <SelectField name="fitness_goal" label="Fitness goal" options={FITNESS_GOAL_OPTIONS} />
                    <SelectField name="activity_level" label="Activity level" options={ACTIVITY_LEVEL_OPTIONS} />
                    <SelectField name="workout_experience" label="Experience" options={WORKOUT_EXPERIENCE_OPTIONS} />
                    <SelectField name="diet_preference" label="Diet preference" options={DIET_PREFERENCE_OPTIONS} />
                  </div>
